    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form action="<?php echo e(route('banners.createOrUpdate')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>

                    <input type="text" name="title" value="<?php echo e($banner->title); ?>" required>
...
<?php /**PATH /Users/huytam/Documents/Laravel/blog/resources/views/dashboard/banner.blade.php ENDPATH**/ ?>
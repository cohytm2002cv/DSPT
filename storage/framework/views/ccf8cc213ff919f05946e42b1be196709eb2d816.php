            ...
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    <strong class="d-inline-block mb-2 text-primary">World</strong>
                        <h3 class="mb-0"> <?php echo e($new->title); ?></h3>
                    <?php if($new->created_at): ?>
                        <div class="mb-1 text-muted"><?php echo e($new->created_at->format('d/m/Y H:i a')); ?></div>
                    <?php else: ?>
                        <div class="mb-1 text-muted">Ngày tạo không xác định</div>
                    <?php endif; ?>                    <p class="card-text mb-auto news-content">
                    <?php echo e($new->content); ?>

                    </p>
                    <a href="<?php echo e(url('news/' . $new->id)); ?>" class="stretched-link">Continue reading</a>
                </div>
                <div class="col-auto d-none d-lg-block" style="width: 250px;">

                     <img width="100%" height="auto" src="<?php echo e(asset($new->image_path)); ?>" alt="Ảnh">
...
<?php /**PATH /Users/huytam/Documents/Laravel/blog/resources/views/news/home.blade.php ENDPATH**/ ?>